...
const TrackingSection = () => {
 ...
 const mockTrackingData: { [key: string]: TrackingStatus[] } = {
  "AFN22385": [
    ...
    { status: "In Transit", location: "Serbia / Hungary Corridor", timestamp: "Sept 11, 2025 12:09", description: "Package has entered Central Europe and is transiting toward Romania", icon: Truck, completed: true},
