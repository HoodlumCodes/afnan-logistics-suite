...
const TrackingSection = () => {
 ...
 const mockTrackingData: { [key: string]: TrackingStatus[] } = {
  "AFN22385": [
    ...
    { status: "Border Crossing", location: "Turkey–Bulgaria Border", timestamp: "Sept 10, 2025 16:15", description: "Package is at the Turkish–Bulgarian border awaiting customs clearance", icon: Truck, completed: false},
