...
const TrackingSection = () => {
 ...
 const mockTrackingData: { [key: string]: TrackingStatus[] } = {
  "AFN22385": [
    ...
    { status: "In Transit", location: "Bruxelles, Belgium", timestamp: "Sept 12, 2025 13:41", description: "Package is currently in Bruxelles, Belgium and is in transit to the Belgium–France–UK border.", icon: Truck, completed: true},
    { status: "Border Clearance", location: "Belgium–France–UK Border", timestamp: "Sept 12, 2025 17:42", description: "Package is held at the Belgium, France, and UK border for customs clearance, insurance verification, and final paperwork.", icon: Truck, completed: false},
  ],
};
